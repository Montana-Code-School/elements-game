...
// Component determineswhich card image will be displayed depending on its
  ...
  render() {
    ...
    if (this.props.className === "playerDeck") {
      ...
      return <CardMedia
        ...
        image={(
          this.props.isStaged !== "")
          ? "https://s3-us-west-2.amazonaws.com/elements-photos/staged.png"
          : null}/>
      ...
      return <CardMedia
        ...
        image={(
          this.props.isStaged !== "")
          ? "https://s3-us-west-2.amazonaws.com/elements-photos/opponentStaged.png"
          : null}/>
