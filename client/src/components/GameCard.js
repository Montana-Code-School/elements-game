...
class GameCard extends Component {
  render() {
    ...
    if (this.props.className === "playerDeck") {
      return <CardMedia component="img" alt={this.props.className} className={`${this.props.className} ${classes.card}`} image="https://s3-us-west-2.amazonaws.com/elements-photos/deck.png"/>
    } else if (this.props.className === "opponentDiscard") {
      return <CardMedia component="img" alt={this.props.className} className={`${this.props.className} ${classes.card}`} image="https://s3-us-west-2.amazonaws.com/elements-photos/opponentDiscard.png"/>
      ...
      return <CardMedia component="img" alt={this.props.className} className={`${this.props.className} ${classes.fieldCard}`} image={`https://s3-us-west-2.amazonaws.com/elements-photos/${this.props.className}.png`} onClick={this.props.onClick}/>
    } else {
      return <CardMedia component="img" alt={this.props.className} className={`${this.props.className} ${classes.multicardDisplayCard}`} image={`https://s3-us-west-2.amazonaws.com/elements-photos/${this.props.className}.png`} onClick={this.props.onClick}/>
    }
  }
}
